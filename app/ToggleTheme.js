class ToggleTheme {
    ...
    changeTheme() {
        if (this.moon.classList.contains("far")) {
            ...
            document.documentElement.style.setProperty('--background-elements', 'hsl(209, 23%, 22%)');
            ...
            document.documentElement.style.setProperty('--box-shadow', '0 0 5px black');
        } else {
            document.documentElement.style.setProperty('--background-color', 'hsl(0, 0%, 98%)');
            document.documentElement.style.setProperty('--background-elements', 'hsl(0, 0%, 100%)');
            ...
            document.documentElement.style.setProperty('--box-shadow', '0 0 5px gray');
        }
...
export const toggleTheme = new ToggleTheme(document.querySelector(".header__toggle"), document.querySelector(".header__toggle__moon"))